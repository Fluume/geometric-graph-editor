...
def save_graph_to_json(file_path, encoded_graph):
    """
    ...
    try:
        ...
        print(f"Erreur lors de la sauvegarde du graphe en JSON : {e}")
...
def load_graph_from_json(file_path):
    ...
    try:
        ...
        print(f"Erreur lors du chargement du graphe depuis le JSON : {e}")
        return None